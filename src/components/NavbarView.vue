<template>
  <div
    class="ease-soft-in-out xl:ml-68.5 left-0 top-0 relative bg-green-600 h-full max-h-screen rounded-xl transition-all duration-200"
    id="panel"
  >
    <!-- <nav
                  ...
                  >
                    <div class="flex py-1">
                      ...
                      <div class="flex flex-col justify-center">
                        ...
                        <p class="mb-0 text-xs leading-tight text-slate-400">
                          <i class="mr-1 fa fa-clock" aria-hidden="true"></i> 1
                          day
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <div class="flex py-1">
                      ...
                      <div class="flex flex-col justify-center">
                        ...
                        <p class="mb-0 text-xs leading-tight text-slate-400">
                          <i class="mr-1 fa fa-clock" aria-hidden="true"></i> 2
                          days
                        </p>
                      </div>
                    </div>
    ...
    <div
      class="w-full bg-blue-500 px-6 py-6 mx-auto loopple-min-height-78vh text-slate-500"
    ></div>
